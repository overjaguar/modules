...
extern "C" {
     ...
     */
    TOBIIGAZE_API void TOBIIGAZE_CALL tobiigaze_send_custom_command(tobiigaze_eye_tracker *eye_tracker, const struct tobiigaze_blob *in_data, struct tobiigaze_blob *out_data, tobiigaze_error_code *error_code);
     ...
     */
    TOBIIGAZE_API void TOBIIGAZE_CALL tobiigaze_send_custom_command_async(tobiigaze_eye_tracker *eye_tracker, const struct tobiigaze_blob *in_data, tobiigaze_async_custom_command_callback callback, void *user_data);
