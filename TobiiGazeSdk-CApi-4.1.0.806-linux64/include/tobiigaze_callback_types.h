...
extern "C" {
    ...
    typedef void (TOBIIGAZE_CALL *tobiigaze_async_custom_command_callback)(const struct tobiigaze_blob *command, tobiigaze_error_code error_code, void *user_data);
    ...
    typedef void (TOBIIGAZE_CALL *tobiigaze_video_listener)(const struct tobiigaze_video_data *gaze_data, void *user_data);

    typedef void (TOBIIGAZE_CALL *tobiigaze_async_stream_types_callback)(const struct tobiigaze_stream_types *stream_types, tobiigaze_error_code error_code, void *user_data);
